...
print(f"Gaz_expense:            ${Gaz_expense: .2f}")
print(f"Accomodation_expense:   ${Accomodation_expense: .2f}")
print(f"Food_expense            ${Food_expense: .2f}")
                         
Total_Travel_Expenses = Gaz_expense + Accomodation_expense + Food_expense

#print(f"Total Travel Expenses:  ${Total_Travel_Expenses: .2f}")
